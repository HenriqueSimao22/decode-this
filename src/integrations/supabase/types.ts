  ...
  public: {
    Tables: {
      ...
      fatura_antecipacoes: {
        ...
        Relationships: [
          {
            foreignKeyName: "fatura_antecipacoes_cartao_id_fkey"
            columns: ["cartao_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "fatura_antecipacoes_fatura_id_fkey"
            columns: ["fatura_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "fatura_antecipacoes_transacao_id_fkey"
            columns: ["transacao_id"]
            isOneToOne: false
            referencedRelation: "transacoes"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "fatura_antecipacoes_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      planejamentos_mensais: {
        ...
        Relationships: [
          {
            foreignKeyName: "planejamentos_mensais_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
        ...
        Relationships: [
          {
            ...
            isOneToOne: false
            referencedRelation: "planejamentos_mensais"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "planejamento_itens_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      planejamento_mensagens: {
        ...
        Relationships: [
          {
            foreignKeyName: "planejamento_mensagens_planejamento_id_fkey"
            columns: ["planejamento_id"]
            isOneToOne: false
            referencedRelation: "planejamentos_mensais"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "planejamento_mensagens_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      metas_aportes: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "metas_aportes_transacao_id_fkey"
            columns: ["transacao_id"]
            isOneToOne: false
            referencedRelation: "transacoes"
            referencedColumns: ["id"]
