...
export const Route = createFileRoute("/_authenticated/cartoes/todos")({
  head: () => ({ meta: [{ title: "Todos os cartões — Livro Caixa" }] }),
  component: TodosCartoesPage,
});

function TodosCartoesPage() {
  ...
  return (
    <div className="space-y-6">
      <Link to="/cartoes" className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground">
        <ArrowLeft className="w-4 h-4" /> Voltar para o cartão
      </Link>
